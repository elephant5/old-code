...
public class Sid {
     ...
     * 返回固定12位的字母数字混编的字符串。
     */
    public String nextShort(String prefix) {
        long id = idWorker.nextId();
        String str = Utils.padLeft(Utils.encode(id), 10, '@');
        return prefix + Utils.getRandomString(str, 10);
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
            String aa = new Sid().nextShort("AC");
