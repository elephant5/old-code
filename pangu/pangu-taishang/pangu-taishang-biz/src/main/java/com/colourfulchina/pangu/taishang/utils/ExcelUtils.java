    ...
    private static String getCellValue(Cell cell) {
        ...
        if (cell.getCellType() == Cell.CELL_TYPE_NUMERIC) {
            if (HSSFDateUtil.isCellDateFormatted(cell)) {
                return DateUtil.toString(HSSFDateUtil.getJavaDate(cell.getNumericCellValue()), "yyyyMMdd");
            } else {
...
//        buildExcelFile(".\\default.xlsx",wb);
     ...
     */
    public static void dowload(HttpServletResponse response,
                               String fileName, String tempFileName) throws IOException {
        response.setContentType("text/html;charset=utf-8");
        InputStream is = null;
        BufferedInputStream bis = null;
        BufferedOutputStream bos = null;
        try {
            is = ExcelUtils.class.getClassLoader().getResourceAsStream(tempFileName);
