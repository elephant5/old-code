...
public class EncryptUtils {
    ...
    public static byte[] encrypts(byte[] data, byte[] key) throws Exception {
        // 还原密钥
        Key k = toKey(key);
        /**
         * 实例化 使用PKCS7Padding填充方式，按如下代码实现
     ...
     * @throws Exception
     */
    public static String getDESStr(String data,String keys) throws  Exception{
        Base64.Decoder decoder = Base64.getDecoder();
        byte[] aa = decoder.decode(data.getBytes());
        byte[] bb = decrypt(aa,keys.getBytes());
