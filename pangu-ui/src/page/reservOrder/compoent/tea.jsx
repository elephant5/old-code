...
class Buffet extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (shopDetail.shop && this.state.isshopDetail && this.state.resourceList.length > 0) {
            ...
            let timeShow = [];
            let start = shopItem.openTime ? shopItem.openTime.split(":")[0] : 14;
            ...
            start = shopItem.openTime ? shopItem.openTime.split(":")[0] : 14;
    ...
    selectShop = values => {
        ...
        this.setState({ resourceList: resourceList, shopItemIdTemp: tempShopItem[0].shopItemId });
                ...
                <div className="c-modal" style={{ marginTop: 0 }}>
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Form.Item verticalGap={1} label="预订时间" labelCol={{ span: 2 }} wrapperCol={{ span: 22 }} direction="horizontal" indicatorGap >
                            ...
                            {(serviceType.type === '下午茶' || serviceType.type === '定制套餐') && getFieldDecorator('giftPeopleNum', { initialValue: "2" })
                                (
