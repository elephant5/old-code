...
const { Option } = Select;
@Form.create()
class ProductGroupCopyFilter extends Component {
    // 查询
    handleSubmit = e => {
        e.preventDefault();
    ...
    render() {
        ...
        const { resourceType, giftTypeList,onEvent ,channelList } = this.props;
        return (
            <div className="c-filter">
                <Form layout="inline" onSubmit={this.handleSubmit}>
                    ...
                    <br></br>
                    <Form.Item>
                        <Button type="primary" onClick={()=>onEvent("submitChooseData")}> + 提交选择  </Button>
...
export default ProductGroupCopyFilter;