...
export default {
    ...
    data() {
        return {
            ...
            calendar3:{
                ...
                show:false,
                zero:true,
                //value:[localStorage.getItem('startDate')], //默认日期
                lunar:true, //显示农历
                multi:false,
                select:(value)=>{
    ...
    methods: {
        ...
        gotolist:function(){
            ...
            // localStorage.setItem('buffetname',this.$refs.buffetname.value);
            // console.log('获取buffetname',this.$refs.buffetname.value);
       },
        formatDate(date) {
            let mymonth = date[1];
